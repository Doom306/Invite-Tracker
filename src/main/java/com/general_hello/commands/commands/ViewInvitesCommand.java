...
public class ViewInvitesCommand extends SlashCommand {
    ...
    protected void execute(SlashCommandEvent event) {
        ...
        embedBuilder.setDescription("You currently have **" + InviteUser.getInvitesFromUser(user) + "** users that you invited. (**" + InviteUser.getRealInvitesFromUser(user) + "** regular, **" + InviteUser.getFakeInvitesFromUser(user) + "** fake)");
